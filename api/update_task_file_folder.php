<?php
/**
 * API Endpoint - Update Task File Folder
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $db->prepare("SELECT id FROM task_attachments WHERE id = ? AND uploaded_by = ?");
    ...
    $stmt = $db->prepare("UPDATE task_attachments SET folder_id = ? WHERE id = ? AND uploaded_by = ?");
